...
pub struct EngineSnapshot {
    ...
    pub paper_unrealized: f64,
    pub paper_realized: f64,
    pub paper_win_rate: Option<f64>,
    pub paper_profit_factor: Option<f64>,
    pub paper_max_drawdown: f64,
    pub paper_fees: f64,
    pub paper_open_count: usize,
    pub paper_closed_count: usize,
